    ...
    <div className="flex p-8">
      ...
      <div>
        ...
        <p>
          ...
          related to it, still belong to Legit Software.
        </p>
        <p>
          Legit Software is committed to ensuring that the app is as useful and
        ...
        <p>
          The Subs Gain app stores and processes personal data that you have
          ...
          Subs Gain app won’t work properly or at all.
        </p>
        <div>
          <p>
        ...
        <p>
          You should be aware that there are certain things that Legit Software
          ...
          can be Wi-Fi, or provided by your mobile network provider, but Rohit
          Kumar cannot take responsibility for the app not working at full
        ...
        <p>
          Along the same lines, Legit Software cannot always take responsibility
          ...
          on to avail the Service, Legit Software cannot accept responsibility.
        </p>
        <p>
          With respect to Legit Software’s responsibility for your use of the
          ...
          that we can make it available to you. Legit Software accepts no
        ...
        <p>
          ...
          keep using the app. Legit Software does not promise that it will
        ...
        <p>These terms and conditions are effective as of 2021-08-18</p>
        <p>
          <strong>Contact Us</strong>
        </p>
        <p>
          If you have any questions or suggestions about my Terms and
          Conditions, do not hesitate to contact me at nnrohu@gmail.com.
        </p>
      </div>
    </div>
  )
